#Chapter 5 pe02
#Description: This code has functions that are used to clulate state and 
#county tax on an price of an item that the user inputs. 
...
#*************************************************************************************************************************
#Chapter 5 pe02
#Description: This code has functions that are used to 
#clulate state and county tax on an price of an item that the user inputs. 
...
# ********************************************************************************
# [shaycraf@hills Ch05]$ python3 pe02.py
# Please enter the amount of purchase: $22
# The purchase amount is: $22.00
# The state tax of 4% on the purchase is:  $0.88
# The county tax of 2% on the purchase is:  $0.44
# The total combined 4% state tax and 2% county tax on the purchase is:  $1.32
# The purchase amount including 4% state and 2% county tax is:  $23.32
...
# [shaycraf@hills Ch05]$ cat pe02.py
# #Chapter 5 pe02
# #Description: This code has functions that are used to clulate state and
# #county tax on an price of an item that the user inputs.
